...
plotW_bar(W_bar_multi_corr, step = 1)
...
results_corr = alply(random_start, 1, calculateTrajectory, G_corr, W_bar_multi, W_bar_multi_grad, scale = 2, .parallel=TRUE)
W_bar_multi_grad(c(1, 1, 1, 1))
