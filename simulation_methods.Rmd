...
![Fig 8. Simulations using random peaks. We see a clear lack of $\Delta z$ with high correlation to gmax. Ijn this simulation, dimensionality of the phenotype is k = 8, and in the multi peak landscape we have N = 50 peaks. Simulations are repeated 1000 times.](plots/peakPool_composite_random.png)
...
![Fig 8. Simulations using random peaks. We see a clear lack of $\Delta z$ with high correlation to gmax. Ijn this simulation, dimensionality of the phenotype is k = 8, and in the multi peak landscape we have N = 50 peaks. Simulations are repeated 1000 times.](plots/peakPool_composite_enriched.png)
